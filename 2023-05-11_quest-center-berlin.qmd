...
::: {.column width="50%"} 
#### {{< fa book-open >}} Chapters/Sessions [Link to the book](https://lennartwittkuhn.com/version-control-book)
::: fragment
...
####### 2. Using basic commands to view, move, and rename files, as well as change directories.
:::

::: fragment
####### 3. Install Git, initiate a local folder as a Git repository, stage and commit changes to files, write descriptive commit messages, and create a .gitignore file.

####### 4. Create, switch, and delete branches, merge branches together, and effectively resolve merge conflict.

####### 5. Establish the connection between Git and GitHub, upload your repository to GitHub, and effectively pull and push changes to files.
:::

::: fragment
####### 6. 

####### 7. Discover how to temporarily stash and retrieve changes to files, and explore the usage of rebase as an alternative to merge.

####### 8. Install a graphical user interface (GUI) client like GitHub Desktop or GitKraken, practice partial commits, and  work on a repository as an RStudio project.
