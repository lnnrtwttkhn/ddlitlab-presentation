...
-   Benefits of version control using Git {{< fa circle-plus >}}

-   Using Git for local version control {{< fa desktop >}}

-   Using remote Git repositories to collaborate  {{< fa cloud >}}

-   Releasing scientific work using Git repositories {{< fa microscope >}}
:::
