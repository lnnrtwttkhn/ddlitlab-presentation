...
🕸 **GRN:** Member of the MPIB's working group on research data management and open science
...
:building_construction: **WIP:** This teaching project is work in progress!

:computer: **Slides:** Slides are publicly available at [lennartwittkuhn.com/talk-rdm](https://lennartwittkuhn.com/ddlitlab-presentation/)
...
::: {.fragment}
... for **code** (text files) {{< fa code >}}
![](static/images/phd-comic-version-control-code-cropped-upper.gif)
:::
::: {.fragment}
![](static/images/phd-comic-version-control-code-cropped-lower.gif)
:::
...
::: {.fragment}
... for **data** (binary files) {{< fa database >}}
![](static/images/phd-comic-version-control-data.gif)
:::
...
{{< fa timeline >}} know the history of what was changed when by whom
...
{{< fa cloud-arrow-up >}} Computational environments on [JupyterHub](https://jupyter.org/hub) 
...
{{< fa star >}} [Course website](https://lennartwittkuhn.com/ddlitlab/) online!
...
## Why should students learn version control?
