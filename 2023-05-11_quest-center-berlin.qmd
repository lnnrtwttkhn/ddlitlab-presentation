...
format:
  revealjs:
    ...
    preview-links: false
    chalkboard: true
    include-after-body: simple-analytics.html
...
{{< fa book-open-reader >}} **Discussions** on reproducibility, open code & data
...
{{< fa recycle >}} Reuse quiz & evaluation results as example datasets
...
{{< fa hammer >}} Integration with [The Carpentries Incubator](https://carpentries-incubator.org/)?
