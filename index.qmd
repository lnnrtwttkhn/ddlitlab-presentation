...
To address the reproducibility crisis, scientists need to adopt tools that enable reproducible and collaborative work on digital research outputs.
Git, a standard tool in software engineering, allows managing the evolution of digital objects, like code and data, but is still not widely used by scientists.
Our full-semester course "Version Control of Code and Data" includes a 200-page online guide for self-paced learning, alongside websites with slides, exercises, and quizzes.
All materials, openly developed on GitHub, are freely available for reuse and collaboration, thereby showcasing an approach to the FAIR and reproducible development of open educational resources.
