...
To address the reproducibility crisis, scientists need to adopt tools that enable reproducible work on digital research outputs.
Git, a standard tool in software engineering, enables traceable collaborative development of digital objects, like code and data, but is still not widely used by scientists.
To change this, we created a course on "Version Control of Code and Data", including a 200-page online guide for self-paced learning, alongside websites with slides, exercises, and quizzes.
All materials, openly developed on GitHub, are freely available for reuse and extension, thereby showcasing an approach to the FAIR and reproducible development of open educational resources.
