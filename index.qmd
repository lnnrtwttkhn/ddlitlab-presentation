...
{{< fa calendar-check >}} **Event:** [49th Annual Conference "Psychology and Brain"](https://pug2024.de/index-en.html) of University of Hamburg, in cooperation with the [Division of Biological Psychology and Neuropsychology of the German Psychological Society (DGPs)](https://www.dgps.de/fachgruppen/fgbi/) and the [German Society for Psychophysiology and its Application (DPGA)](https://www.dgpa.de) </br>
{{< fa map-pin >}} **Venue:** [49th Annual Conference "Psychology and Brain"](https://pug2024.de/index-en.html) at the Bürgerhaus Wilhemsburg, Hamburg </br>
{{< fa clock >}} **Date:** 2024-05-29 - 2024-06.01 </br>
{{< fa chalkboard-user >}} **Presenters:** [Dr. Lennart Wittkuhn](https://www.lennartwittkuhn.com/) & Konrad Pagenstedt

### Abstract

```{=html}
<iframe width="100%" height="560" src="texts/2024-05-29_pug_abstract.qmd"></iframe>
```
