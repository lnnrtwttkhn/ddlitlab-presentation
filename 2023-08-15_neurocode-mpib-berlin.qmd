...
:robot: **Source:** Source code is publicly available on GitHub at [github.com/lnnrtwttkhn/ddlitlab-presentation](https://github.com/lnnrtwttkhn/ddlitlab-presentation/)
...
:spiral_notepad: **Notes:** Collaborative notes on [HedgeDoc](https://pad.uni-hamburg.de/o3KaCSe5TBSLFvyLYJl1dA?both)
...
Present that we are planning to do content-wise

1. Session topic (focus)
1. Why do we teach about this topic?
1. Link to chapter in version control book
1. Which quiz questions, if available
1. Which exercises, if available
1. How complete?

Questions:

- Any topics that you are missing?
...
::: {.incremental style="font-size: 40px;"}
